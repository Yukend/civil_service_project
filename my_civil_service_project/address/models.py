...
class Address(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE,
                                   blank=True, null=True, related_name=CREATE_SHOP_ADDRESS)
    updated_by = models.ForeignKey(User, on_delete=models.CASCADE,
                                   blank=True, null=True, related_name=UPDATE_SHOP_ADDRESS)
    module = models.ForeignKey(AddressType, on_delete=models.CASCADE, related_name=ADDRESS_MODULE)
