...
class Shop(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE,
                                   blank=True, null=True, related_name=CREATE_SHOP)
    updated_by = models.ForeignKey(User, on_delete=models.CASCADE,
                                   blank=True, null=True, related_name=UPDATE_SHOP)
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name=SHOPS, null=True)
